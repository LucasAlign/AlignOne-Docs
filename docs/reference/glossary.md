...
<!-- @frontend: fill every "In-app label" cell with the exact text shown in the app, then remove this marker. -->
...
| **Schedule / event** | A planned event on the family's calendar. | _TBD_ |
| **Recurring event** | An event that repeats on a rule. | _TBD_ |
| **Thread** | A message conversation among participants. | _TBD_ |
| **Message** | A single entry within a thread. | _TBD_ |
| **Read receipt** | Shows that a message has been read. | _TBD_ |
| **Post** | An update shared with the family's circle. | _TBD_ |
